      ...
      <div class="modal-body">
        ...
        <form id="form-crear-usuario" action="{{ route('users.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control @error('password', 'store') is-invalid @enderror" id="password" name="password" placeholder="Contraseña" value="{{ old('password') }}">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('cedula', 'store') is-invalid @enderror" id="cedula" name="cedula" placeholder="Cédula" value="{{ old('cedula') }}">
          </div>
          @error('cedula', 'store')<div class="invalid-feedback">{{ $message }}</div>@enderror
          <div class="mb-3">
            <label for="email1" class="col-form-label">Correo 1 <span class="text-danger">*</span></label>
            <input type="email" class="form-control @error('email1', 'store') is-invalid @enderror" id="email1" name="email1" placeholder="Correo 1" value="{{ old('email1') }}">
          </div>
          @error('email1', 'store')<div class="invalid-feedback">{{ $message }}</div>@enderror
          <div class="mb-3">
            <label for="email2" class="col-form-label">Correo 2 <span class="text-danger">*</span></label>
            <input type="email" class="form-control @error('email2', 'store') is-invalid @enderror" id="email2" name="email2" placeholder="Correo 2" value="{{ old('email2') }}">
          </div>
          @error('email2', 'store')<div class="invalid-feedback">{{ $message }}</div>@enderror
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-control @error('empresa_id', 'store') is-invalid @enderror" id="empresa_id" name="empresa_id">
          ...
          @error('empresa_id', 'store')<div class="invalid-feedback">{{ $message }}</div>@enderror
          <div class="mb-3">
            <label for="rol_id" class="col-form-label">Rol <span class="text-danger">*</span></label>
            <select class="form-control @error('rol_id', 'store') is-invalid @enderror" id="rol_id" name="rol_id">
          ...
          @error('rol_id', 'store')<div class="invalid-feedback">{{ $message }}</div>@enderror
        </form>
      </div>
